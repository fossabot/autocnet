...
def ring_match_one(x, y, ref_feats, tar_feats, ref_desc, tar_desc, ring, search_radius=100, target_points=5):
    """
...
def add_correspondences(in_feats, ref_feats, tar_feats, ref_desc, tar_desc,  xextent, yextent, ring, n_x_cells=5, n_y_cells=5, target_points=5):
    """
    ...
    for i in range(1, n_x_cells):
        for j in range(1, n_y_cells):
            ...
            ref = ring_match_one(x_cell_center, y_cell_center, ref_feats, tar_feats, ref_desc, tar_desc, ring)
